	...
	<v-flex xs12>
		...
		<v-layout row wrap v-if="currentType == 2 || currentType == 3">
			...
			<v-flex xs12  mb-3 v-if="currentType == 2">
				<v-card class="elevation-1" color="red lighten-4" >
					<v-flex xs12 pa-2>
						<p><v-btn round color="red" dark large outline icon>4</v-btn>
		...
		<v-layout row wrap v-if="currentType == 2 || currentType == 3">
				...
				<v-flex xs12 mb-3>
					<v-card class="elevation-1" color="brown lighten-4" >
						<v-flex xs12 pa-2>
							<v-btn round color="brown" dark large outline icon>5</v-btn>
